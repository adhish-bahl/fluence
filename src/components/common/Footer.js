...
export default function Footer() {
  return (
    <footer className="bg-[#502D1D] text-[#FAF8F5] mt-20">
      ...
      <div className="max-w-6xl mx-auto px-6 py-14 grid md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <p className="mt-3 text-sm text-[#E8D9D1]">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2 text-sm text-[#E8D9D1]">
        ...
        <div>
          ...
          <div className="flex flex-col gap-3 text-sm text-[#E8D9D1]">
